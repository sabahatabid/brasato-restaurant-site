...
const values = [
  {
    ...
    description:
      "We source our produce daily from local farms and trusted Italian importers.",
  },
  {
    icon: Heart,
    title: "Cooked with Passion",
    description:
      "Every plate is a reflection of our chefs' deep love for authentic Italian cooking.",
  },
  {
    icon: Award,
    title: "Award-Winning Quality",
    description:
      "Recognised by the Michelin Guide and rated among the city's top 10 restaurants.",
  },
  {
    icon: Users,
    title: "Warm Hospitality",
    description:
      "We treat every guest as family — because that's what Italian dining is all about.",
  },
];
...
export default function About() {
  ...
  return (
    <section id="about" className="py-24 bg-brand-cream relative overflow-hidden">
      ...
      <div className="absolute top-20 right-10 w-40 h-40 border-2 border-brand-orange/10 rounded-full" />
      <div className="absolute bottom-20 left-10 w-60 h-60 border-2 border-brand-orange/10 rounded-full" />
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-brand-orange/3 rounded-full blur-3xl pointer-events-none" />
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            {/* Years badge */}
            <div className="absolute -top-6 -left-6 hidden sm:flex w-28 h-28 bg-brand-orange rounded-full items-center justify-center shadow-xl shadow-brand-orange/30 flex-col">
          ...
          >
            <h3 className="font-display text-3xl font-bold text-brand-brown mb-6 leading-tight">
              A Legacy Born in the <span className="text-brand-orange">Heart of Naples</span>
            </h3>

            <div className="space-y-4 text-gray-600 leading-relaxed">
              <p>
                Brasato was born in 1998 from a simple but powerful idea — that the
                best meals are the ones shared with people you love, around a table filled
                with food made from the heart.
              </p>
              <p>
                Our founder, Chef Marco Rossetti, grew up watching his grandmother transform
                humble ingredients into extraordinary dishes in her Neapolitan kitchen. He
                carried those lessons — and her handwritten recipe book — all the way to this
